...
class PodcastFeedGenerator:
    ...
    def _add_channel_metadata(self, channel: ET.Element):
        ...
        # Podcast namespace
        self.xml.add_ns_element(channel, PODCAST_NS, "locked", text_content="yes")
    ...
    def _add_channel_itunes_metadata(self, channel: ET.Element):
        ...
        # Block the podcast from iTunes search / Apple Podcasts
        self.xml.add_ns_element(channel, ITUNES_NS, "block", text_content="yes")
